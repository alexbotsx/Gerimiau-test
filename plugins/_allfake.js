...
handler.all = async function (m) {
    ...
    //Emojis determinado de GERIMIAUBOT Bot
    global.emoji = '🍁'
    global.emoji2 = '⭐'
    global.emoji3 = '✨️'
    global.emoji4 = '😴'
    ...
    // global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "56941827124-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: `${packname}`, orderTitle: 'Bang', thumbnail: icons, sellerJid: '0@s.whatsapp.net'}}}
    ...
    global.icono = [
        'https://cdn.russellxz.click/a8f9e711.jpg',
        'https://cdn.russellxz.click/a8f9e711.jpg',
        'https://cdn.russellxz.click/a8f9e711.jpg'
    ].getRandom()
